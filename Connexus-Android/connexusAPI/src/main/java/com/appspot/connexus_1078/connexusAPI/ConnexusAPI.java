...
public class ConnexusAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetStream getStream(java.lang.String user) throws java.io.IOException {
    GetStream result = new GetStream(user);
    initialize(result);
    return result;
  }

  public class GetStream extends ConnexusAPIRequest<com.appspot.connexus_1078.connexusAPI.model.ConnexusRespondStreams> {
     ...
     * @since 1.13
     */
    protected GetStream(java.lang.String user) {
      super(ConnexusAPI.this, "GET", REST_PATH, null, com.appspot.connexus_1078.connexusAPI.model.ConnexusRespondStreams.class);
    ...
    public GetStream setUser(java.lang.String user) {
      this.user = user;
      return this;
    }
