...
public final class ConnexusResponseImages extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<ConnexusImageInfo> images;

  /**
   * @return value or {@code null} for none
   */
  public java.util.List<ConnexusImageInfo> getImages() {
    return images;
  }
   ...
   */
  public ConnexusResponseImages setImages(java.util.List<ConnexusImageInfo> images) {
    this.images = images;
    return this;
  }
