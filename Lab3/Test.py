...
class MyTestCase(unittest.TestCase):
  ...
  def test_t8(self):
    r1 = Experiment.largest([-sys.maxint,-sys.maxint-1])
    self.assertEqual(r1, -sys.maxint)

  def test_t9(self):
    r1 = Experiment.largest([-sys.maxint-1,-sys.maxint-1])
    self.assertEqual(r1, -sys.maxint-1)
